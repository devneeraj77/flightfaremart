...
<hr class="text-secondary">
  ...
  <div class="bg-[#f9f9f9] dark:bg-[#1b2c2d] text-accent dark:text-light py-10">
  ...
  <!-- Top dark section -->
  <div class="bg-secondary dark:bg-primary text-dark py-10">
    <div class="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 px-6">
      ...
      <div >
        ...
        <p class="text-base opacity-90 flex gap-2 py-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="bg-trans icon icon-tabler icons-tabler-filled icon-tabler-mail"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M22 7.535v9.465a3 3 0 0 1 -2.824 2.995l-.176 .005h-14a3 3 0 0 1 -2.995 -2.824l-.005 -.176v-9.465l9.445 6.297l.116 .066a1 1 0 0 0 .878 0l.116 -.066l9.445 -6.297z" /><path d="M19 4c1.08 0 2.027 .57 2.555 1.427l-9.555 6.37l-9.555 -6.37a2.999 2.999 0 0 1 2.354 -1.42l.201 -.007h14z" /></svg> hello@flightfaremart.com</p>
        <p class="text-base opacity-90 flex gap-2 py-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="bg-trans icon icon-tabler icons-tabler-filled icon-tabler-map-pin"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M18.364 4.636a9 9 0 0 1 .203 12.519l-.203 .21l-4.243 4.242a3 3 0 0 1 -4.097 .135l-.144 -.135l-4.244 -4.243a9 9 0 0 1 12.728 -12.728zm-6.364 3.364a3 3 0 1 0 0 6a3 3 0 0 0 0 -6z" /></svg> 703 Waterford Way, Suite 600, <br> Miami, FL 33126.</p>
        <p class="text-base opacity-90 flex gap-2 py-2"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="bg-trans icon icon-tabler icons-tabler-filled icon-tabler-phone">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      ...
      <div>
        ...
        <div class="flex h-[38px] text-[18px] text-white/60">
          <input
            class="input w-[200px] bg-trans text-black px-3 py-1  border border-white/10 focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-2 focus:ring-offset-accent transition-all duration-150 ease-in-out"
            name="text"
            type="text"
            placeholder="Email" />
          <button
    ...
    <div class="text-center text-xs mt-10 opacity-70">
      © 2025 FlightFareMart. All rights reserved.
    </div>
  </div>
